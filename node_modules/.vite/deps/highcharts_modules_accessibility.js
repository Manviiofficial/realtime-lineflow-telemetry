    ...
    */
    function(e, t) {
      ...
      let K = { fireEventOnWrappedOrUnwrappedElement: function e10(t10, i10) {
        ...
        O?.createEvent && (t10.dispatchEvent || t10.fireEvent) ? t10.dispatchEvent ? t10.dispatchEvent(i10) : t10.fireEvent(s10, i10) : n2 && n2[s10] ? z(t10, s10, i10) : t10.element && e10(t10.element, i10);
      ...
      } }, { doc: G } = w(), { removeElement: W } = S, V = class {
        constructor() {
          this.elements = [];
        }
        createElement() {
          let e10 = G.createElement.apply(G, arguments);
          return this.elements.push(e10), e10;
        }
        removeElement(e10) {
          W(e10), this.elements.splice(this.elements.indexOf(e10), 1);
        }
        ...
        initBase(e10, t10) {
          this.chart = e10, this.eventProvider = new Y(), this.domElementProvider = new V(), this.proxyProvider = t10, this.keyCodes = { left: 37, right: 39, up: 38, down: 40, enter: 13, space: 32, esc: 27, tab: 9, pageUp: 33, pageDown: 34, end: 35, home: 36 };
        }
      ...
      let { doc: eh } = w(), { addClass: ec, visuallyHideElement: ed } = S, { attr: eu } = w(), ep = class {
        constructor(e10, t10) {
          this.chart = e10, this.domElementProvider = new V(), this.announceRegion = this.addAnnounceRegion(t10);
        }
        destroy() {
      ...
      let eL = class extends Z {
        ...
        defaultBeforeChartFormatter() {
          ...
          if (!t10) return "";
          let i10 = this.getAxesDescription(), s10 = e10.sonify && e10.options.sonification && e10.options.sonification.enabled, n2 = "highcharts-a11y-sonify-data-btn-" + e10.index, r2 = "hc-linkto-highcharts-data-table-" + e10.index, o2 = ew(e10), a2 = e10.langFormat("accessibility.screenReaderSection.annotations.heading", { chart: e10 }), l2 = { headingTagName: eD(e10.renderTo), chartTitle: eT(e10), typeDescription: this.getTypeDescriptionText(), chartSubtitle: this.getSubtitleText(), chartLongdesc: this.getLongdescText(), xAxisDescription: i10.xAxis, yAxisDescription: i10.yAxis, playAsSoundButton: s10 ? this.getSonifyButtonText(n2) : "", viewTableButton: e10.exporting?.getCSV ? this.getDataTableButtonText(r2) : "", annotationsTitle: o2 ? a2 : "", annotationsList: o2 }, h2 = F.i18nFormat(t10, l2, e10);
      ...
      }, { attr: eH } = w(), { getChartTitle: ez, unhideChartElementFromAT: eq } = K, { getFakeMouseEvent: eU } = S;
      function eK(e10) {
      ...
      class eG extends Z {
        ...
        onMenuShown() {
          let e10 = this.chart, t10 = e10.exporting?.contextMenuEl;
        ...
        onChartRender() {
          ...
          this.proxyProvider.clearGroup("chartMenu"), this.proxyMenuButton(), this.exportButtonProxy && t10 && t10 === e10.exporting?.group && (t10.focusBorder ? e10.setFocusToElement(t10, this.exportButtonProxy.innerElement) : i10 && i10.keyboardNavigation.tabindexContainer.focus());
        }
        proxyMenuButton() {
        ...
        addAccessibleContextMenuAttribs() {
          let e10 = this.chart, t10 = e10.exporting?.divElements;
          if (t10 && t10.length) {
            t10.forEach((e11) => {
        ...
        getKeyboardNavigation() {
          ...
          return new Q(t10, { keyCodeMap: [[[e10.left, e10.up], function() {
            ...
            return !!t10.exporting && t10.options.exporting?.buttons?.contextButton.enabled !== false && false !== t10.options.exporting.enabled && false !== (t10.options.exporting.accessibility?.enabled || false);
          }, init: function() {
            let e11 = i10.exportButtonProxy, s10 = i10.chart.exporting?.group;
        ...
        onKbdNext(e10) {
          ...
          for (let e11 = (t10.highlightedExportItemIx || 0) + 1; e11 < (t10.exporting?.divElements?.length || 0); ++e11) if (t10.highlightExportItem(e11)) return s10.success;
          return i10.keyboardNavigation.wrapAround ? (t10.highlightExportItem(0), s10.success) : s10.next;
        }
        onKbdClick(e10) {
          let t10 = this.chart, i10 = void 0 !== t10.highlightedExportItemIx && t10.exporting?.divElements?.[t10.highlightedExportItemIx], s10 = eK(t10)?.element;
          return t10.exporting?.openMenu ? i10 && this.fakeClickEvent(i10) : (s10 && this.fakeClickEvent(s10), t10.highlightExportItem(0)), e10.response.success;
        }
      }
      !function(e10) {
        function t10() {
          ...
          if (e11) {
            let t11 = e11.element;
            t11.onclick && t11.onclick(eU("click"));
          }
        }
        function i10() {
        ...
        function s10(e11) {
          let t11 = this.exporting?.divElements?.[e11], i11 = void 0 !== this.highlightedExportItemIx && this.exporting?.divElements?.[this.highlightedExportItemIx];
      ...
      let eW = eG, { doc: eV, win: eX } = w(), { addEvent: eY, defined: ej, fireEvent: e_ } = w(), { getElement: eZ, simulatedEventTarget: e$ } = S;
      class eQ {
        constructor(e10, t10) {
        ...
        createExitAnchor() {
          let e10 = this.chart, t10 = this.exitAnchor = eV.createElement("div");
      ...
      !function(e10) {
        ...
        e10.compose = function(e11) {
          ...
          return !s10.dismissPopupContent && (s10.dismissPopupContent = t10, eV && eY(eV, "keydown", i10)), e11;
        };
      }(eQ || (eQ = {}));
      let eJ = eQ;
      ...
      class tr extends Z {
        ...
        proxyLegendItem(e10) {
          let t10 = e10.legendItem || {}, i10 = e10.legendItem?.label, s10 = i10?.element, n2 = t10.label?.styles?.textOverflow === "ellipsis";
          ...
          n2 && -1 !== (s10.textContent || "").indexOf("…") && (o2.title = i10?.textStr);
      ...
      !function(e10) {
        function t10(e11) {
          let t11 = this.legend.allItems, i11 = this.accessibility && this.accessibility.components.legend.highlightedLegendItemIx, s10 = t11[e11], n2 = s10?.legendItem || {};
          if (s10) {
      ...
      function tP(e10) {
        ...
        if (this.isXAxis && (n2?.enabled || a2?.enabled)) {
      ...
      let { parse: tO } = tB(), { seriesTypes: tR } = tF(), tL = { height: 40, margin: 22, maskInside: true, handles: { width: 7, borderRadius: 0, height: 15, symbols: ["navigator-handle", "navigator-handle"], enabled: true, lineWidth: 1, backgroundColor: "#f2f2f2", borderColor: "#999999" }, maskFill: tO("#667aff").setOpacity(0.3).get(), outlineColor: "#999999", outlineWidth: 1, series: { type: void 0 === tR.areaspline ? "line" : "areaspline", fillOpacity: 0.05, lineWidth: 1, compare: null, sonification: { enabled: false }, dataGrouping: { approximation: "average", enabled: true, groupPixelWidth: 2, firstAnchor: "firstPoint", anchor: "middle", lastAnchor: "lastPoint", units: [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2, 3, 4]], ["week", [1, 2, 3]], ["month", [1, 3, 6]], ["year", null]] }, dataLabels: { enabled: false, zIndex: 2 }, id: "highcharts-navigator-series", className: "highcharts-navigator-series", lineColor: null, marker: { enabled: false }, threshold: null }, xAxis: { className: "highcharts-navigator-xaxis", tickLength: 0, lineWidth: 0, gridLineColor: "#e6e6e6", id: "navigator-x-axis", gridLineWidth: 1, tickPixelInterval: 200, labels: { align: "left", style: { color: "#000000", fontSize: "0.7em", opacity: 0.6, textOutline: "2px contrast" }, x: 3, y: -4 }, crosshair: false }, yAxis: { className: "highcharts-navigator-yaxis", gridLineWidth: 0, startOnTick: false, endOnTick: false, minPadding: 0.1, id: "navigator-y-axis", maxPadding: 0.1, labels: { enabled: false }, crosshair: false, title: { text: void 0 }, tickLength: 0, tickWidth: 0 } }, { defined: tH, isNumber: tz, pick: tq } = w(), tU = { rect: function(e10, t10, i10, s10, n2) {
        return n2?.r ? function(e11, t11, i11, s11, n3) {
          let r2 = n3?.r || 0;
      ...
      } }, { relativeLength: tK } = w(), tG = { "navigator-handle": function(e10, t10, i10, s10, n2 = {}) {
      ...
      var tW = x(608), tV = x.n(tW);
      let { defined: tX } = w(), { defaultOptions: tY } = w(), { composed: tj } = w(), { getRendererType: t_ } = tV(), { setFixedRange: tZ } = { setFixedRange: function(e10) {
      ...
      let t1 = { compose: function(e10, t10, i10) {
        tD.compose(t10), tJ(tj, "Navigator") && (e10.prototype.setFixedRange = tZ, tQ(t_().prototype.symbols, tG), tQ(tY, { navigator: tL }), t$(i10, "afterUpdate", t0));
      } }, { composed: t2 } = w(), { addEvent: t3, defined: t5, pick: t4, pushUnique: t6 } = w();
      !function(e10) {
        let t10;
        function i10(e11) {
          let t11 = t4(e11.options?.min, e11.min), i11 = t4(e11.options?.max, e11.max);
        ...
        function n2() {
          let e11 = this;
          e11.options?.scrollbar?.enabled && (e11.options.scrollbar.vertical = !e11.horiz, e11.options.startOnTick = e11.options.endOnTick = false, e11.scrollbar = new t10(e11.chart.renderer, e11.options.scrollbar, e11.chart), t3(e11.scrollbar, "changed", function(t11) {
            let s11, n3, { axisMin: r3, axisMax: o2, scrollMin: a2, scrollMax: l2 } = i10(e11), h2 = l2 - a2;
            if (t5(r3) && t5(o2)) if (e11.horiz && !e11.reversed || !e11.horiz && e11.reversed ? (s11 = a2 + h2 * this.to, n3 = a2 + h2 * this.from) : (s11 = a2 + h2 * (1 - this.from), n3 = a2 + h2 * (1 - this.to)), this.shouldUpdateExtremes(t11.DOMType)) {
      ...
      let t9 = g, t8 = { height: 10, barBorderRadius: 5, buttonBorderRadius: 0, buttonsEnabled: false, liveRedraw: void 0, margin: void 0, minWidth: 6, opposite: true, step: 0.2, zIndex: 3, barBackgroundColor: "#cccccc", barBorderWidth: 0, barBorderColor: "#cccccc", buttonArrowColor: "#333333", buttonBackgroundColor: "#e6e6e6", buttonBorderColor: "#cccccc", buttonBorderWidth: 1, rifleColor: "none", trackBackgroundColor: "rgba(255, 255, 255, 0.001)", trackBorderColor: "#cccccc", trackBorderRadius: 5, trackBorderWidth: 1 }, { defaultOptions: t7 } = w(), { composed: ie } = w(), { addEvent: it, correctFloat: ii, crisp: is, defined: ir, destroyObjectProperties: io, extend: ia, fireEvent: il, merge: ih, pick: ic, pushUnique: id, removeEvent: iu } = w();
      class ip {
        static compose(e10) {
          t9.compose(e10, ip), id(ie, "Scrollbar") && ia(t7, { scrollbar: t8 });
        }
        ...
        buttonToMaxClick(e10) {
          let t10 = (this.to - this.from) * ic(this.options.step, 0.2);
          this.updatePosition(this.from + t10, this.to + t10), il(this, "changed", { from: this.from, to: this.to, trigger: "scrollbar", DOMEvent: e10 });
        }
        buttonToMinClick(e10) {
          let t10 = ii(this.to - this.from) * ic(this.options.step, 0.2);
          this.updatePosition(ii(this.from - t10), ii(this.to - t10)), il(this, "changed", { from: this.from, to: this.to, trigger: "scrollbar", DOMEvent: e10 });
        }
        ...
        destroy() {
          ...
          }), t10 && e10 === t10.scrollbar && (t10.scrollbar = null, io(t10.scrollbarButtons));
        }
        drawScrollbarButton(e10) {
          ...
          if (i10.push(r2), s10.buttonsEnabled) {
            ...
            let a2 = t10.path(ip.swapXY([["M", n2 / 2 + (e10 ? -1 : 1), n2 / 2 - 3], ["L", n2 / 2 + (e10 ? -1 : 1), n2 / 2 + 3], ["L", n2 / 2 + (e10 ? 2 : -2), n2 / 2]], s10.vertical)).addClass("highcharts-scrollbar-arrow").add(i10[e10]);
            this.chart.styledMode || a2.attr({ fill: s10.buttonArrowColor });
          }
        }
        init(e10, t10, i10) {
          this.scrollbarButtons = [], this.renderer = e10, this.userOptions = t10, this.options = ih(t8, t7.scrollbar, t10), this.options.margin = ic(this.options.margin, 10), this.chart = i10, this.size = ic(this.options.size, this.options.height), t10.enabled && (this.render(), this.addEvents());
        }
        mouseDownHandler(e10) {
          let t10 = this.chart.pointer?.normalize(e10) || e10, i10 = this.cursorToScrollbarPosition(t10);
        ...
        mouseMoveHandler(e10) {
          let t10, i10 = this.chart.pointer?.normalize(e10) || e10, s10 = this.options.vertical ? "chartY" : "chartX", n2 = this.initPositions || [];
          this.grabbedCenter && (!e10.touches || 0 !== e10.touches[0][s10]) && (t10 = this.cursorToScrollbarPosition(i10)[s10] - this[s10], this.hasDragged = true, this.updatePosition(n2[0] + t10, n2[1] + t10), this.hasDragged && il(this, "changed", { from: this.from, to: this.to, trigger: "scrollbar", DOMType: e10.type, DOMEvent: e10 }));
        }
        mouseUpHandler(e10) {
          this.hasDragged && il(this, "changed", { from: this.from, to: this.to, trigger: "scrollbar", DOMType: e10.type, DOMEvent: e10 }), this.grabbedCenter = this.hasDragged = this.chartX = this.chartY = null;
        }
        ...
        render() {
          ...
          this.track.attr({ x: -is(0, r2), y: -is(0, r2) }), this.scrollbarGroup = e10.g().add(n2), this.scrollbar = e10.rect().addClass("highcharts-scrollbar-thumb").attr({ height: i10 - r2, width: i10 - r2, r: t10.barBorderRadius || 0 }).add(this.scrollbarGroup), this.scrollbarRifles = e10.path(ip.swapXY([["M", -3, i10 / 4], ["L", -3, 2 * i10 / 3], ["M", 0, i10 / 4], ["L", 0, 2 * i10 / 3], ["M", 3, i10 / 4], ["L", 3, 2 * i10 / 3]], t10.vertical)).addClass("highcharts-scrollbar-rifles").add(this.scrollbarGroup), s10 || (this.scrollbar.attr({ fill: t10.barBackgroundColor, stroke: t10.barBorderColor, "stroke-width": t10.barBorderWidth }), this.scrollbarRifles.attr({ stroke: t10.rifleColor, "stroke-width": 1 })), this.scrollbarStrokeWidth = this.scrollbar.strokeWidth(), this.scrollbarGroup.translate(-is(0, this.scrollbarStrokeWidth), -is(0, this.scrollbarStrokeWidth)), this.drawScrollbarButton(0), this.drawScrollbarButton(1);
        }
        setRange(e10, t10) {
          ...
          i10 = Math.ceil(a2 * (e10 = Math.max(e10, 0))), this.calculatedWidth = s10 = ii(h2 - i10), s10 < o2 && (i10 = (a2 - o2 + s10) * e10, s10 = o2);
        ...
        shouldUpdateExtremes(e10) {
          return ic(this.options.liveRedraw, w().svg && !w().isTouchDevice && !this.chart.boosted) || "mouseup" === e10 || "touchend" === e10 || !ir(e10);
        }
        trackClick(e10) {
          let t10 = this.chart.pointer?.normalize(e10) || e10, i10 = this.to - this.from, s10 = this.y + this.scrollbarTop, n2 = this.x + this.scrollbarLeft;
          this.options.vertical && t10.chartY > s10 || !this.options.vertical && t10.chartX > n2 ? this.updatePosition(this.from + i10, this.to + i10) : this.updatePosition(this.from - i10, this.to - i10), il(this, "changed", { from: this.from, to: this.to, trigger: "scrollbar", DOMEvent: e10 });
        }
        update(e10) {
          this.destroy(), this.init(this.chart.renderer, ih(true, this.options, e10), this.chart);
        }
        updatePosition(e10, t10) {
          t10 > 1 && (e10 = ii(1 - ii(t10 - e10)), t10 = 1), e10 < 0 && (t10 = ii(t10 - e10), e10 = 0), this.from = e10, this.to = t10;
        }
      }
      ip.defaultOptions = t8;
      var ig = x(540), im = x.n(ig);
      let { defaultOptions: ib } = w(), { isTouchDevice: ix } = w(), { prototype: { symbols: iy } } = im(), { addEvent: iv, clamp: iw, correctFloat: iE, defined: iA, destroyObjectProperties: iT, erase: iC, extend: iM, find: ik, fireEvent: iS, isArray: iP, isNumber: iD, merge: iN, pick: iB, removeEvent: iI, splat: iF } = w();
      function iO(e10, ...t10) {
        let i10 = [].filter.call(t10, iD);
        if (i10.length) return Math[e10].apply(0, i10);
      }
      class iR {
        static compose(e10, t10, i10) {
          tw.compose(e10, iR), t1.compose(e10, t10, i10);
        }
        constructor(e10) {
        ...
        renderElements() {
          ...
          }), e10.outline || (e10.outline = r2.path().addClass("highcharts-navigator-outline").add(a2)), s10.styledMode || e10.outline.attr({ "stroke-width": t10.outlineWidth, stroke: t10.outlineColor }), t10.handles?.enabled) {
            ...
            [0, 1].forEach((t11) => {
              ...
              if (e10.handles[t11] && e10.handles[t11].symbolUrl === h2) {
                if (!e10.handles[t11].isImg && e10.handles[t11].symbolName !== h2) {
                  let i12 = iy[h2].call(iy, -l2 / 2 - 1, 0, l2, n3);
                  e10.handles[t11].attr({ d: i12 }), e10.handles[t11].symbolName = h2;
                }
              } else e10.handles[t11]?.destroy(), e10.handles[t11] = r2.symbol(h2, -l2 / 2 - 1, 0, l2, n3, i11), e10.handles[t11].attr({ zIndex: 7 - t11 }).addClass("highcharts-navigator-handle highcharts-navigator-handle-" + ["left", "right"][t11]).add(a2), e10.addMouseEvents();
        ...
        update(e10, t10 = false) {
          ...
          if (iN(true, i10.options.navigator, e10), this.navigatorOptions = i10.options.navigator || {}, this.setOpposite(), iA(e10.enabled) || s10) return this.destroy(), this.navigatorEnabled = e10.enabled || this.navigatorEnabled, this.init(i10);
          if (this.navigatorEnabled && (this.isDirty = true, false === e10.adaptToUpdatedData && this.baseSeries.forEach((e11) => {
            iI(e11, "updatedData", this.updatedDataHandler);
          }, this), e10.adaptToUpdatedData && this.baseSeries.forEach((e11) => {
            e11.eventsToUnbind.push(iv(e11, "updatedData", this.updatedDataHandler));
        ...
        render(e10, t10, i10, s10) {
          ...
          if (this.hasDragged && !iA(i10)) return;
          if (this.isDirty && this.renderElements(), e10 = iE(e10 - o2 / 2), t10 = iE(t10 + o2 / 2), !iD(e10) || !iD(t10)) if (!h2) return;
          else i10 = 0, s10 = iB(r2.width, a2.width);
          this.left = iB(r2.left, n2.plotLeft + p2 + (c2 ? n2.plotWidth : 0));
          let v2 = this.size = x2 = iB(r2.len, (c2 ? n2.plotHeight : n2.plotWidth) - 2 * p2);
          g2 = c2 ? f2 : x2 + 2 * p2, i10 = iB(i10, r2.toPixels(e10, true)), s10 = iB(s10, r2.toPixels(t10, true)), iD(i10) && Math.abs(i10) !== 1 / 0 || (i10 = 0, s10 = g2);
          let w2 = r2.toValue(i10, true), E2 = r2.toValue(s10, true), A2 = Math.abs(iE(E2 - w2));
          A2 < d2 ? this.grabbedLeft ? i10 = r2.toPixels(E2 - d2 - o2, true) : this.grabbedRight && (s10 = r2.toPixels(w2 + d2 + o2, true)) : iA(u2) && iE(A2 - o2) > u2 && (this.grabbedLeft ? i10 = r2.toPixels(E2 - u2 - o2, true) : this.grabbedRight && (s10 = r2.toPixels(w2 + u2 + o2, true))), this.zoomedMax = iw(Math.max(i10, s10), 0, v2), this.zoomedMin = iw(this.fixedWidth ? this.zoomedMax - this.fixedWidth : Math.min(i10, s10), 0, v2), this.range = this.zoomedMax - this.zoomedMin, v2 = Math.round(this.zoomedMax);
          let T2 = Math.round(this.zoomedMin);
          l2 && (this.navigatorGroup.attr({ visibility: "inherit" }), y2 = h2 && !this.hasDragged ? "animate" : "attr", this.drawMasks(T2, v2, c2, y2), this.drawOutline(T2, v2, c2, y2), this.navigatorOptions.handles.enabled && (this.drawHandle(T2, 0, c2, y2), this.drawHandle(v2, 1, c2, y2))), this.scrollbar && (c2 ? (b2 = this.top - p2, m2 = this.left - f2 + (l2 || !a2.opposite ? 0 : (a2.titleOffset || 0) + a2.axisTitleMargin), f2 = x2 + 2 * p2) : (b2 = this.top + (l2 ? this.height : -f2), m2 = this.left - p2), this.scrollbar.position(m2, b2, g2, f2), this.scrollbar.setRange(this.zoomedMin / (x2 || 1), this.zoomedMax / (x2 || 1))), this.rendered = true, this.isDirty = false, iS(this, "afterRender");
        }
        addMouseEvents() {
          ...
          e10.mouseMoveHandler = n2 = function(t11) {
            ...
            e10.onMouseUp(t11);
          }, (s10 = e10.getPartsEvents("mousedown")).push(iv(t10.renderTo, "mousemove", n2), iv(i10.ownerDocument, "mouseup", r2), iv(t10.renderTo, "touchmove", n2), iv(i10.ownerDocument, "touchend", r2)), s10.concat(e10.getPartsEvents("touchstart")), e10.eventsToUnbind = s10, e10.series && e10.series[0] && s10.push(iv(e10.series[0].xAxis, "foundExtremes", function() {
        ...
        getPartsEvents(e10) {
          ...
          return ["shades", "handles"].forEach(function(s10) {
            t10[s10].forEach(function(n2, r2) {
              i10.push(iv(n2.element, e10, function(e11) {
        ...
        onMouseMove(e10) {
          ...
          (!e10.touches || 0 !== e10.touches[0].pageX) && (l2 = (e10 = i10.pointer?.normalize(e10) || e10).chartX, o2 && (a2 = t10.top, l2 = e10.chartY), t10.grabbedLeft ? (t10.hasDragged = true, t10.render(0, 0, l2 - a2, t10.otherHandlePos)) : t10.grabbedRight ? (t10.hasDragged = true, t10.render(0, 0, t10.otherHandlePos, l2 - a2)) : t10.grabbedCenter && (t10.hasDragged = true, l2 < r2 ? l2 = r2 : l2 > s10 + r2 - n2 && (l2 = s10 + r2 - n2), t10.render(0, 0, l2 - r2, l2 - r2 + n2)), t10.hasDragged && t10.scrollbar && iB(t10.scrollbar.options.liveRedraw, !ix && !this.chart.boosted) && (e10.DOMType = e10.type, setTimeout(function() {
            t10.onMouseUp(e10);
          }, 0)));
        }
        onMouseUp(e10) {
        ...
        removeBaseSeriesEvents() {
          ...
          this.navigatorEnabled && e10[0] && (false !== this.navigatorOptions.adaptToUpdatedData && e10.forEach(function(e11) {
            iI(e11, "updatedData", this.updatedDataHandler);
          }, this), e10[0].xAxis && iI(e10[0].xAxis, "foundExtremes", this.modifyBaseAxisExtremes));
        }
        getXAxisOffsets() {
        ...
        init(e10) {
          ...
          if (e10.isDirtyBox = true, h2.navigatorEnabled) {
            let t11 = this.getXAxisOffsets();
            h2.xAxis = new (tl())(e10, iN({ breaks: p2.options.breaks, ordinal: p2.options.ordinal, overscroll: p2.options.overscroll }, i10.xAxis, { type: "datetime", yAxis: i10.yAxis?.id, index: d2, isInternal: true, offset: 0, keepOrdinalPadding: true, startOnTick: false, endOnTick: false, minPadding: p2.options.ordinal ? 0 : p2.options.minPadding, maxPadding: p2.options.ordinal ? 0 : p2.options.maxPadding, zoomEnabled: false }, e10.inverted ? { offsets: t11, width: o2 } : { offsets: t11, height: o2 }), "xAxis"), h2.yAxis = new (tl())(e10, iN(i10.yAxis, { alignTicks: false, offset: 0, index: u2, isInternal: true, reversed: iB(i10.yAxis && i10.yAxis.reversed, e10.yAxis[0] && e10.yAxis[0].reversed, false), zoomEnabled: false }, e10.inverted ? { width: o2 } : { height: o2 }), "yAxis"), c2 || i10.series.data ? h2.updateNavigatorSeries(false) : 0 === e10.series.length && (h2.unbindRedraw = iv(e10, "beforeRedraw", function() {
            ...
            let s11 = e10.xAxis[0], n3 = s11.getExtremes(), r3 = s11.len - 2 * l2, o3 = iO("min", s11.options.min, n3.dataMin), a3 = iO("max", s11.options.max, n3.dataMax) - o3;
          ...
          if (e10.options.scrollbar?.enabled) {
            let t11 = iN(e10.options.scrollbar, { vertical: e10.inverted });
            iD(t11.margin) || (t11.margin = e10.inverted ? -3 : 3), e10.scrollbar = h2.scrollbar = new ip(e10.renderer, t11, e10), iv(h2.scrollbar, "changed", function(e11) {
        ...
        setOpposite() {
          ...
          this.opposite = iB(e10.opposite, !!(!t10 && i10.inverted));
        }
        getUnionExtremes(e10) {
          let t10, i10 = this.chart.xAxis[0], s10 = this.chart.time, n2 = this.xAxis, r2 = n2.options, o2 = i10.options;
          return e10 && null === i10.dataMin || (t10 = { dataMin: iB(s10.parse(r2?.min), iO("min", s10.parse(o2.min), i10.dataMin, n2.dataMin, n2.min)), dataMax: iB(s10.parse(r2?.max), iO("max", s10.parse(o2.max), i10.dataMax, n2.dataMax, n2.max)) }), t10;
        }
        setBaseSeries(e10, t10) {
          let i10 = this.chart, s10 = this.baseSeries = [];
          e10 = e10 || i10.options && i10.options.navigator.baseSeries || (i10.series.length ? ik(i10.series, (e11) => !e11.options.isInternal).index : 0), (i10.series || []).forEach((t11, i11) => {
        ...
        updateNavigatorSeries(e10, t10) {
          let i10 = this, s10 = i10.chart, n2 = i10.baseSeries, r2 = { enableMouseTracking: false, index: null, linkedTo: null, group: "nav", padXAxis: false, xAxis: this.navigatorOptions.xAxis?.id, yAxis: this.navigatorOptions.yAxis?.id, showInLegend: false, stacking: void 0, isInternal: true, states: { inactive: { opacity: 1 } } }, o2 = i10.series = (i10.series || []).filter((e11) => {
            let t11 = e11.baseSeries;
            return !(0 > n2.indexOf(t11)) || (t11 && (iI(t11, "updatedData", i10.updatedDataHandler), delete t11.navigatorSeries), e11.chart && e11.destroy(), false);
          }), a2, l2, h2 = i10.navigatorOptions.series, c2;
          n2 && n2.length && n2.forEach((e11) => {
            let d2 = e11.navigatorSeries, u2 = iM({ color: e11.color, visible: e11.visible }, iP(h2) ? ib.navigator.series : h2);
            if (d2 && false === i10.navigatorOptions.adaptToUpdatedData) return;
            r2.name = "Navigator " + n2.length, c2 = (a2 = e11.options || {}).navigatorOptions || {}, u2.dataLabels = iF(u2.dataLabels), (l2 = iN(a2, r2, u2, c2)).pointRange = iB(u2.pointRange, c2.pointRange, ib.plotOptions[l2.type || "line"].pointRange);
            let p2 = c2.data || u2.data;
            i10.hasNavigatorData = i10.hasNavigatorData || !!p2, l2.data = p2 || a2.data?.slice(0), d2 && d2.options ? d2.update(l2, t10) : (e11.navigatorSeries = s10.initSeries(l2), s10.setSortedData(), e11.navigatorSeries.baseSeries = e11, o2.push(e11.navigatorSeries));
          }), (h2.data && !(n2 && n2.length) || iP(h2)) && (i10.hasNavigatorData = false, (h2 = iF(h2)).forEach((e11, t11) => {
            r2.name = "Navigator " + (o2.length + 1), (l2 = iN(ib.navigator.series, { color: s10.series[t11] && !s10.series[t11].options.isInternal && s10.series[t11].color || s10.options.colors[t11] || s10.options.colors[0] }, r2, e11)).data = e11.data, l2.data && (i10.hasNavigatorData = true, o2.push(s10.initSeries(l2)));
          })), e10 && this.addBaseSeriesEvents();
        }
        addBaseSeriesEvents() {
          let e10 = this, t10 = e10.baseSeries || [];
          t10[0] && t10[0].xAxis && t10[0].eventsToUnbind.push(iv(t10[0].xAxis, "foundExtremes", this.modifyBaseAxisExtremes)), t10.forEach((i10) => {
            i10.eventsToUnbind.push(iv(i10, "show", function() {
              this.navigatorSeries && this.navigatorSeries.setVisible(true, false);
            })), i10.eventsToUnbind.push(iv(i10, "hide", function() {
              this.navigatorSeries && this.navigatorSeries.setVisible(false, false);
            })), false !== this.navigatorOptions.adaptToUpdatedData && i10.xAxis && i10.eventsToUnbind.push(iv(i10, "updatedData", this.updatedDataHandler)), i10.eventsToUnbind.push(iv(i10, "remove", function() {
              t10 && iC(t10, i10), this.navigatorSeries && e10.series && (iC(e10.series, this.navigatorSeries), iA(this.navigatorSeries.options) && this.navigatorSeries.remove(false), delete this.navigatorSeries);
            }));
          });
        }
        ...
        modifyBaseAxisExtremes() {
          let e10, t10, i10 = this.chart.navigator, s10 = this.getExtremes(), n2 = s10.min, r2 = s10.max, o2 = s10.dataMin, a2 = s10.dataMax, l2 = r2 - n2, h2 = i10.stickToMin, c2 = i10.stickToMax, d2 = iB(this.ordinal?.convertOverscroll(this.options.overscroll), 0), u2 = i10.series && i10.series[0], p2 = !!this.setExtremes;
          !(this.eventArgs && "rangeSelectorButton" === this.eventArgs.trigger) && (h2 && (e10 = (t10 = o2) + l2), c2 && (e10 = a2 + d2, h2 || (t10 = Math.max(o2, e10 - l2, i10.getBaseSeriesMin(u2 && u2.xData ? u2.xData[0] : -Number.MAX_VALUE)))), p2 && (h2 || c2) && iD(t10) && (this.min = this.userMin = t10, this.max = this.userMax = e10)), i10.stickToMin = i10.stickToMax = null;
        }
        updatedDataHandler() {
          ...
          e10.stickToMax = iB(this.chart.options.navigator && this.chart.options.navigator.stickToMax, i10), e10.stickToMin = e10.shouldStickToMin(this, e10), t10 && !e10.hasNavigatorData && (t10.options.pointStart = this.getColumn("x")[0], t10.setData(this.options.data, false, null, false));
        }
        shouldStickToMin(e10, t10) {
          ...
          return !!(iD(n2) && iD(r2)) && (o2 && n2 - i10 > 0 ? n2 - i10 < o2 : r2 <= i10);
        }
        addChartEvents() {
          this.eventsToUnbind || (this.eventsToUnbind = []), this.eventsToUnbind.push(iv(this.chart, "redraw", function() {
            ...
            this.inverted && (t10 = e10.opposite ? "marginRight" : "plotLeft"), this[t10] = (this[t10] || 0) + (e10.navigatorEnabled || !this.inverted ? e10.height + (this.scrollbar?.options.margin || 0) + e10.scrollbarHeight : 0) + (e10.navigatorOptions.margin || 0);
          }), iv(iR, "setRange", function(e10) {
      ...
      let { animObject: iL } = w(), { format: iH } = D(), { clamp: iz, pick: iq, syncTimeout: iU } = w(), { getFakeMouseEvent: iK } = S, { getAxisRangeDescription: iG, fireEventOnWrappedOrUnwrappedElement: iW } = K, iV = class extends Z {
        init() {
          let e10 = this.chart, t10 = this;
          this.announcer = new ep(e10, "polite"), this.addEvent(iR, "afterRender", function() {
            this.chart === t10.chart && this.chart.renderer && iU(() => {
              t10.proxyProvider.updateGroupProxyElementPositions("navigator"), t10.updateHandleValues();
            }, iL(iq(this.chart.renderer.globalAnimation, true)).duration);
          });
        }
        onChartUpdate() {
          let e10 = this.chart, t10 = e10.options, i10 = t10.navigator;
          if (i10.enabled && i10.accessibility?.enabled) {
            let i11 = t10.accessibility.landmarkVerbosity, s10 = t10.lang.accessibility?.navigator.groupLabel;
            this.proxyProvider.removeGroup("navigator"), this.proxyProvider.addGroup("navigator", "div", { role: "all" === i11 ? "region" : "group", "aria-label": iH(s10, { chart: e10 }, e10) });
            let n2 = t10.lang.accessibility?.navigator.handleLabel;
            [0, 1].forEach((t11) => {
              let i12 = this.getHandleByIx(t11);
              if (i12) {
                let s11 = this.proxyProvider.addProxyElement("navigator", { click: i12 }, "input", { type: "range", "aria-label": iH(n2, { handleIx: t11, chart: e10 }, e10) });
        ...
        getNavigatorHandleNavigation(e10) {
          ...
          return new Q(i10, { keyCodeMap: [[[n2.left, n2.right, n2.up, n2.down], function(r2) {
            if (s10) {
              ...
              s10.value = "" + iz(parseFloat(s10.value) + o2, 0, 100), t10.updateNavigator(() => {
          ...
          }, validate: () => !!(this.getHandleByIx(e10) && s10 && i10.options.navigator.accessibility?.enabled) });
        }
        getKeyboardNavigation() {
          ...
          this.updateNavigatorThrottleTimer && clearTimeout(this.updateNavigatorThrottleTimer), this.updateNavigatorThrottleTimer = setTimeout(((e11) => {
            ...
            if (i10 && s10 && this.minHandleProxy && this.maxHandleProxy) {
              ...
              [[0, "mousedown", i10.zoomedMin], [0, "mousemove", r2], [0, "mouseup", r2], [1, "mousedown", i10.zoomedMax], [1, "mousemove", o2], [1, "mouseup", o2]].forEach(([e12, t11, s11]) => {
                ...
                r3 && iW(r3, iK(t11, { x: n2.left + i10.left + s11, y: n2.top + i10.top }, r3));
              }), e11 && e11();
              let a2 = t10.options.lang.accessibility?.navigator.changeAnnouncement, l2 = iG(t10.xAxis[0]);
              this.announcer.announce(iH(a2, { axisRangeDescription: l2, chart: t10 }, t10));
            }
          }).bind(this, e10), 20);
        }
      }, { getPointAnnotationTexts: iX } = ev, { getAxisDescription: iY, getSeriesFirstPointElement: ij, getSeriesA11yElement: i_, unhideChartElementFromAT: iZ } = K, { format: i$, numberFormat: iQ } = D(), { reverseChildNodes: iJ, stripHTMLTagsFromString: i0 } = S, { find: i1, isNumber: i2, isString: i3, pick: i5, defined: i4 } = w();
      function i6(e10) {
      ...
      function i9(e10, t10) {
        ...
        return i2(t10) ? iQ(t10, r2.valueDecimals || n2.valueDecimals || o2.valueDecimals || -1, a2.decimalPoint, a2.accessibility.thousandsSep || a2.thousandsSep) : t10;
      }
      function i8(e10, t10) {
        let i10 = e10[t10];
        return e10.chart.langFormat("accessibility.series." + t10 + "Description", { name: iY(i10), series: e10 });
      }
      function i7(e10) {
        let t10 = e10.series, i10 = t10.chart.series.length > 1 || t10.options.name, s10 = function(e11) {
          let t11 = e11.series, i11 = t11.chart, s11 = t11.options.accessibility, n3 = s11 && s11.point && s11.point.valueDescriptionFormat || i11.options.accessibility.point.valueDescriptionFormat, r3 = i5(t11.xAxis && t11.xAxis.options.accessibility && t11.xAxis.options.accessibility.enabled, !i11.angular && "flowmap" !== t11.type), o3 = r3 ? function(e12) {
            ...
            }(e12), i12 = (e12.series.xAxis || {}).categories && i4(e12.category) && ("" + e12.category).replace("<br/>", " "), s12 = i4(e12.id) && 0 > ("" + e12.id).indexOf("highcharts-"), n4 = "x, " + e12.x;
            return e12.name || t12 || i12 || (s12 ? e12.id : n4);
          }(e11) : "";
          return i$(n3, { point: e11, index: i4(e11.index) ? e11.index + 1 : "", xDescription: o3, value: function(e12) {
            let t12 = e12.series, i12 = t12.chart.options.accessibility.point || {}, s12 = t12.chart.options.accessibility && t12.chart.options.accessibility.point || {}, n4 = t12.tooltipOptions || {}, r4 = s12.valuePrefix || i12.valuePrefix || n4.valuePrefix || "", o4 = s12.valueSuffix || i12.valueSuffix || n4.valueSuffix || "", a2 = void 0 !== e12.value ? "value" : "y", l2 = i9(e12, e12[a2]);
            ...
            if (t12.pointArrayMap) {
              let t13 = r4 || "", i13 = o4 || "", s13 = function(s14) {
                let n5 = i9(e12, i5(e12[s14], e12.options[s14]));
          ...
          let t11 = e11.series.chart, i11 = iX(e11);
      ...
      function se(e10) {
        ...
        }, r2 = e10.index + 1, o2 = i8(e10, "xAxis"), a2 = i8(e10, "yAxis"), l2 = { seriesNumber: r2, series: e10, chart: t10 }, h2 = i10.length > 1 ? "Combination" : "", c2 = t10.langFormat("accessibility.series.summary." + e10.type + h2, l2) || t10.langFormat("accessibility.series.summary.default" + h2, l2), d2 = (n2("yAxis") ? " " + a2 + "." : "") + (n2("xAxis") ? " " + o2 + "." : "");
        return i$(i5(e10.options.accessibility && e10.options.accessibility.descriptionFormat, t10.options.accessibility.series.descriptionFormat, ""), { seriesDescription: c2, authorDescription: s10 ? " " + s10 : "", axisDescription: d2, series: e10, chart: t10, seriesNumber: r2 }, void 0);
      }
      let st = { defaultPointDescriptionFormatter: i7, defaultSeriesDescriptionFormatter: se, describeSeries: function(e10) {
        let t10 = e10.chart, i10 = ij(e10), s10 = i_(e10), n2 = t10.is3d && t10.is3d();
        if (s10) {
          s10.lastChild !== i10 || n2 || iJ(s10);
          let r2 = function(e11) {
            let t11 = e11.options.accessibility || {};
            return !i6(e11) && !t11.exposeAsGroupOnly;
          }(e10), o2 = function(e11) {
          ...
          if ((r2 || o2) && e10.points.forEach((t11) => {
            let i11 = t11.graphic && t11.graphic.element || function(e11) {
              ...
              let t12 = e11.series, i12 = function(e12) {
                let t13 = e12.index;
                if (!e12.series || !e12.series.data || !i4(t13)) return null;
                let i13 = e12.series.options?.nullInteraction;
                return i1(e12.series.data, function(e13) {
                  return !!(e13 && void 0 !== e13.index && (i13 || e13.index > t13) && e13.graphic && e13.graphic.element);
                }) || null;
              }(e11), s12 = i12 && i12.graphic, n3 = s12 ? s12.parentGroup : t12.graph || t12.group, r3 = i12 ? { x: i5(e11.plotX, i12.plotX, 0), y: i5(e11.plotY, i12.plotY, 0) } : { x: i5(e11.plotX, 0), y: i5(e11.plotY, 0) }, o3 = function(e12, t13) {
            ...
            if (i11) {
              ...
              if (i11.setAttribute("tabindex", "-1"), e10.chart.styledMode || (i11.style.outline = "none"), r2 && !s11) {
                let e11 = t11.series, s12 = e11.options.accessibility?.point || {}, n3 = e11.chart.options.accessibility.point || {}, r3 = i0(i3(s12.descriptionFormat) && i$(s12.descriptionFormat, t11, e11.chart) || s12.descriptionFormatter?.(t11) || i3(n3.descriptionFormat) && i$(n3.descriptionFormat, t11, e11.chart) || n3.descriptionFormatter?.(t11) || i7(t11), e11.chart.renderer.forExport);
                i11.setAttribute("role", "img"), i11.setAttribute("aria-label", r3);
              } else i11.setAttribute("aria-hidden", true);
            }
          }), iZ(t10, s10), function(e11) {
            ...
            return !(s11 && n3) && (n3 || r3 || o3 || i6(e11));
          }(e10)) {
            let t11 = e10.options.accessibility || {}, i11 = e10.chart.options.accessibility, n3 = i11.landmarkVerbosity;
            t11.exposeAsGroupOnly ? s10.setAttribute("role", "img") : "all" === n3 ? s10.setAttribute("role", "region") : s10.setAttribute("role", "group"), s10.setAttribute("tabindex", "-1"), e10.chart.styledMode || (s10.style.outline = "none"), s10.setAttribute("aria-label", i0(i11.series.descriptionFormatter && i11.series.descriptionFormatter(e10) || se(e10), e10.chart.renderer.forExport));
          } else s10.removeAttribute("aria-label");
        }
      } }, { composed: si } = w(), { addEvent: ss, defined: sn, pushUnique: sr } = w(), { getChartTitle: so } = K, { defaultPointDescriptionFormatter: sa, defaultSeriesDescriptionFormatter: sl } = st;
      function sh(e10) {
      ...
      class sc {
        ...
        onSeriesAdded(e10) {
          sh(this.chart) && (this.dirty.hasDirty = true, this.dirty.allSeries[e10.name + e10.index] = e10, this.dirty.newSeries = sn(this.dirty.newSeries) ? void 0 : e10);
        }
        announceDirtyData() {
          let e10 = this.chart, t10 = this;
        ...
        buildAnnouncementMessage(e10, t10, i10) {
          ...
          let r2 = w().charts && w().charts.length > 1 ? "Multiple" : "Single", o2 = t10 ? "newSeriesAnnounce" + r2 : i10 ? "newPointAnnounce" + r2 : "newDataAnnounce", a2 = so(s10);
          return s10.langFormat("accessibility.announceNewData." + o2, { chartTitle: a2, seriesDesc: t10 ? sl(t10) : null, pointDesc: i10 ? sa(i10) : null, point: i10, series: t10 });
        }
      }
      !function(e10) {
        function t10(e11) {
          let t11 = this.chart, i11 = t11.accessibility?.components.series.newDataAnnouncer;
          i11 && i11.chart === t11 && sh(t11) && (i11.dirty.newPoint = sn(i11.dirty.newPoint) ? void 0 : e11.point);
        }
        function i10() {
          let e11 = this.chart, t11 = e11.accessibility?.components.series.newDataAnnouncer;
          t11 && t11.chart === e11 && sh(e11) && (t11.dirty.hasDirty = true, t11.dirty.allSeries[this.name + this.index] = this);
        }
        e10.compose = function(e11) {
          sr(si, "A11y.NDA") && (ss(e11, "addPoint", t10), ss(e11, "updatedData", i10));
        };
      }(sc || (sc = {}));
      let sd = sc, { doc: su, win: sp } = w(), { attr: sg, css: sm, merge: sb } = w(), { fireEventOnWrappedOrUnwrappedElement: sf } = K, { cloneMouseEvent: sx, cloneTouchEvent: sy, getFakeMouseEvent: sv, removeElement: sw } = S, sE = class {
        constructor(e10, t10, i10 = "button", s10, n2) {
          this.chart = e10, this.target = t10, this.eventProvider = new Y();
          let r2 = this.innerElement = su.createElement(i10), o2 = this.element = s10 ? su.createElement(s10) : r2;
        ...
        click() {
          ...
          let t10 = sv("click", e10);
          sf(this.target.click, t10);
        }
        updateTarget(e10, t10) {
          ...
          sg(this.innerElement, sb(s10 ? { "aria-label": s10 } : {}, i10)), this.eventProvider.removeAddedEvents(), this.addProxyEventsToElement(this.innerElement, e10.click), this.refreshPosition();
        }
        refreshPosition() {
          let e10 = this.getTargetPosition();
          sm(this.innerElement, { width: (e10.width || 1) + "px", height: (e10.height || 1) + "px", left: (Math.round(e10.x) || 0) + "px", top: (Math.round(e10.y) || 0) + "px" });
        }
        remove() {
        ...
        addProxyEventsToElement(e10, t10) {
          ["click", "touchstart", "touchend", "touchcancel", "touchmove", "mouseover", "mouseenter", "mouseleave", "mouseout"].forEach((i10) => {
            ...
            this.eventProvider.addEvent(e10, i10, (e11) => {
              let i11 = s10 ? sy(e11) : sx(e11);
              t10 && sf(t10, i11), e11.stopPropagation(), s10 || e11.preventDefault();
            }, { passive: false });
          });
        }
        hideElementVisually(e10) {
          sm(e10, { borderWidth: 0, backgroundColor: "transparent", cursor: "pointer", outline: "none", opacity: 1e-3, filter: "alpha(opacity=1)", zIndex: 999, overflow: "hidden", padding: 0, margin: 0, display: "block", position: "absolute", "-ms-filter": "progid:DXImageTransform.Microsoft.Alpha(Opacity=1)" });
        }
        getTargetPosition() {
          ...
          if (s10 && i10?.getBoundingClientRect && n2) {
            let e11 = sp.scrollY || su.documentElement.scrollTop, t11 = i10.getBoundingClientRect(), s11 = n2.getChartPosition();
      ...
      }, { doc: sA } = w(), { attr: sT, css: sC } = w(), { unhideChartElementFromAT: sM } = K, { removeChildNodes: sk } = S, sS = class {
        constructor(e10) {
          this.chart = e10, this.domElementProvider = new V(), this.groups = {}, this.groupOrder = [], this.beforeChartProxyPosContainer = this.createProxyPosContainer("before"), this.afterChartProxyPosContainer = this.createProxyPosContainer("after"), this.update();
        }
        addProxyElement(e10, t10, i10 = "button", s10) {
          ...
          let r2 = "ul" === n2.type || "ol" === n2.type ? "li" : void 0, o2 = new sE(this.chart, t10, i10, r2, s10);
        ...
        updatePosContainerPositions() {
          ...
          e10.container.insertBefore(this.afterChartProxyPosContainer, t10.nextSibling), e10.container.insertBefore(this.beforeChartProxyPosContainer, t10), sM(this.chart, this.afterChartProxyPosContainer), sM(this.chart, this.beforeChartProxyPosContainer);
        }
      }, { unhideChartElementFromAT: sP, getAxisRangeDescription: sD } = K, { addEvent: sN, attr: sB } = w();
      class sI extends Z {
        init() {
          let e10 = this.chart;
        ...
        onChartUpdate() {
          ...
          i10 && (this.updateSelectorVisibility(), this.setDropdownAttrs(), i10.buttons && i10.buttons.length && i10.buttons.forEach((e11) => {
            ...
            let r2 = i10[s10];
            r2 && (sP(e10, r2), t10.setRangeInputAttrs(r2, "accessibility.rangeSelector." + (n2 ? "max" : "min") + "InputLabel"));
          }));
        }
        updateSelectorVisibility() {
          ...
          t10 && t10.hasVisibleDropdown && i10 ? (sP(e10, i10), s10.forEach((e11) => n2(e11.element))) : (i10 && n2(i10), s10.forEach((t11) => sP(e10, t11.element)));
        }
        setDropdownAttrs() {
        ...
        setRangeButtonAttrs(e10) {
          sB(e10.element, { tabindex: -1, role: "button" });
        }
        setRangeInputAttrs(e10, t10) {
          let i10 = this.chart;
          sB(e10, { tabindex: -1, "aria-label": i10.langFormat(t10, { chart: i10 }) });
        }
        ...
        onAfterBtnClick() {
          let e10 = this.chart, t10 = sD(e10.xAxis[0]), i10 = e10.langFormat("accessibility.rangeSelector.clickButtonAnnouncement", { chart: e10, axisRangeDescription: t10 });
        ...
        onInputNavInit(e10) {
          ...
          if (i10.highlightedInputRangeIx = s10, r2 && o2 && a2) {
            ...
            }, n3 = sN(o2, "keydown", e11), l2 = sN(a2, "keydown", e11);
        ...
        initDropdownNav() {
          ...
          t10 && i10 && (e10.setFocusToElement(t10.buttonGroup, i10), this.removeDropdownKeydownHandler && this.removeDropdownKeydownHandler(), this.removeDropdownKeydownHandler = sN(i10, "keydown", (t11) => {
      ...
      !function(e10) {
        ...
        e10.compose = function(e11, s10) {
          let n2 = e11.prototype;
          n2.highlightRangeSelectorButton || (n2.highlightRangeSelectorButton = t10, sN(s10, "afterBtnClick", i10));
        };
      }(sI || (sI = {}));
      let sF = sI, { composed: sO } = w(), { addEvent: sR, merge: sL, pushUnique: sH } = w();
      !function(e10) {
        function t10(e11) {
          sL(true, e11, { marker: { enabled: true, states: { normal: { opacity: 0 } } } });
        }
        function i10(e11) {
        ...
        function r2(e11) {
          this.resetA11yMarkerOptions = sL(e11.options.marker || {}, this.userOptions.marker || {});
        }
        function o2() {
          ...
          !function(e12) {
            ...
            for (; s11--; ) {
              ...
              if (delete r3.hasForcedA11yMarker, o3.marker) {
                var n3;
                let e13 = a3 && 0 === i10(o3);
                o3.marker.enabled && !e13 ? (sL(true, (n3 = o3).marker, { states: { normal: { opacity: i10(n3) || 1 } } }), r3.hasForcedA11yMarker = false) : false === o3.marker.enabled && (t10(o3), r3.hasForcedA11yMarker = true);
              }
            }
          }(this));
        }
        function a2() {
          this.boosted && this.a11yMarkersForced && (sL(true, this.options, { marker: { enabled: false } }), delete this.a11yMarkersForced);
        }
        e10.compose = function(e11) {
          sH(sO, "A11y.FM") && (sR(e11, "afterSetOptions", r2), sR(e11, "render", o2), sR(e11, "afterRender", n2), sR(e11, "renderCanvas", a2));
        };
      }(m || (m = {}));
      let sz = m;
      var sq = x(260), sU = x.n(sq), sK = x(820), sG = x.n(sK);
      let { seriesTypes: sW } = tF(), { doc: sV } = w(), { defined: sX, fireEvent: sY } = w(), { getPointFromXY: sj, getSeriesFromName: s_, scrollAxisToPoint: sZ } = K;
      function s$(e10) {
      ...
      function sJ(e10) {
        let t10 = e10.series, i10 = t10.options.nullInteraction, s10 = e10.options.accessibility, n2 = t10.chart.options.accessibility, r2 = s10?.enabled === false;
        return n2.keyboardNavigation.seriesNavigation.skipNullPoints ?? (!(!e10.isNull || i10) && false === e10.visible || false === e10.isInside || r2 || sQ(t10));
      }
      function s0(e10) {
        let t10 = e10.series || [], i10 = t10.length;
        for (let e11 = 0; e11 < i10; ++e11) if (!sQ(t10[e11])) {
          let i11 = function(e12) {
            let t11 = e12.points || [], i12 = t11.length;
            for (let e13 = 0; e13 < i12; ++e13) if (!sJ(t11[e13])) return t11[e13];
            return null;
          }(t10[e11]);
          if (i11) return i11;
        }
      ...
      class s3 {
        ...
        init() {
          ...
          i10.addEvent(sG(), "destroy", function() {
          ...
          }), i10.addEvent(sU(), "afterSetState", function() {
            let e11 = this.graphic && this.graphic.element, i11 = sV.activeElement, s10 = i11 && i11.getAttribute("class"), n2 = s10 && s10.indexOf("highcharts-a11y-proxy-element") > -1;
            t10.highlightedPoint === this && i11 !== e11 && !n2 && e11 && e11.focus && e11.focus();
          });
        }
        onDrillupAll() {
          let e10, t10 = this.lastDrilledDownPoint, i10 = this.chart, s10 = t10 && s_(i10, t10.seriesName);
          t10 && s10 && sX(t10.x) && sX(t10.y) && (e10 = sj(s10, t10.x, t10.y)), e10 = e10 || s0(i10), i10.container && i10.container.focus(), e10 && e10.highlight && e10.highlight(false);
        }
        getKeyboardNavigationHandler() {
          ...
          return new Q(i10, { keyCodeMap: [[s10 ? [t10.up, t10.down] : [t10.left, t10.right], function(t11) {
            ...
            if (s11) {
              ...
              t11 = { ...t11, chartX: e12 + n2, chartY: i11 + r2, point: s11, target: s11.graphic?.element || t11.target }, sY(s11.series, "click", t11), s11.firePointEvent("click", t11);
            }
            return this.response.success;
          }], [[t10.home], function() {
            return s2(i10), this.response.success;
          }], [[t10.end], function() {
            return s1(i10), this.response.success;
        ...
        onHandlerInit(e10) {
          let t10 = this.chart;
          return t10.options.accessibility.keyboardNavigation.seriesNavigation.rememberPointFocus && t10.highlightedPoint ? t10.highlightedPoint.highlight() : s2(t10), e10.response.success;
        }
        ...
        attemptHighlightAdjacentPoint(e10, t10) {
          ...
          return i10.highlightAdjacentPoint(t10) ? e10.response.success : s10 && (t10 ? s2(i10) : s1(i10)) ? e10.response.success : e10.response[t10 ? "next" : "prev"];
        }
        onSeriesDestroy(e10) {
          let t10 = this.chart;
      ...
      !function(e10) {
        function t10(e11) {
          let t11, i11, s11 = this.series, n3 = this.highlightedPoint, r3 = n3 && s$(n3) || 0, o2 = n3 && n3.series.points || [], a2 = this.series && this.series[this.series.length - 1], l2 = a2 && a2.points && a2.points[a2.points.length - 1];
          ...
          return sJ(i11) ? (sQ(t11 = i11.series) ? this.highlightedPoint = e11 ? t11.points[t11.points.length - 1] : t11.points[0] : this.highlightedPoint = i11, this.highlightAdjacentPoint(e11)) : i11.highlight();
        }
        function i10(e11) {
          let t11 = this.highlightedPoint, i11 = 1 / 0, s11;
          return !!sX(t11.plotX) && !!sX(t11.plotY) && (this.series.forEach((n3) => {
            sQ(n3) || n3.points.forEach((r3) => {
              if (!sX(r3.plotY) || !sX(r3.plotX) || r3 === t11) return;
              let o2 = r3.plotY - t11.plotY, a2 = Math.abs(r3.plotX - t11.plotX), l2 = Math.abs(o2) * Math.abs(o2) + a2 * a2 * 4;
              n3.yAxis && n3.yAxis.reversed && (o2 *= -1), !(o2 <= 0 && e11 || o2 >= 0 && !e11 || l2 < 5 || sJ(r3)) && l2 < i11 && (i11 = l2, s11 = r3);
            });
          }), !!s11 && s11.highlight());
        }
        function s10(e11) {
          ...
          return this.highlightedPoint ? !!(t11 = this.series[n3.series.index + (e11 ? -1 : 1)]) && !!(i11 = function(e12, t12, i12, s12) {
            let n4 = 1 / 0, r4, o3, a2, l2 = t12.points.length, h2 = (e13) => !(sX(e13.plotX) && sX(e13.plotY));
            if (!h2(e12)) {
              ...
              return sX(o3) ? t12.points[o3] : void 0;
            }
          }(n3, t11, 4)) && (sQ(t11) ? (i11.highlight(), s11 = this.highlightAdjacentSeries(e11)) ? s11 : (n3.highlight(), false) : (i11.highlight(), i11.series.highlightNextValidPoint())) : (t11 = e11 ? this.series && this.series[0] : r3, !!(i11 = e11 ? t11 && t11.points && t11.points[0] : o2) && i11.highlight());
        }
        function n2(e11 = true) {
          let t11 = this.series.chart, i11 = t11.tooltip?.label?.element;
          (!this.isNull || this.series.options?.nullInteraction) && e11 ? this.onMouseOver() : t11.tooltip && t11.tooltip.hide(0), sZ(this), this.graphic && (t11.setFocusToElement(this.graphic), !e11 && t11.focusElement && t11.focusElement.removeFocusBorder()), t11.highlightedPoint = this;
          let s11 = i11?.getBoundingClientRect().top;
          if (i11 && s11 && s11 < 0) {
        ...
        function r2() {
          let e11 = this.chart.highlightedPoint, t11 = (e11 && e11.series) === this ? s$(e11) : 0, i11 = this.points, s11 = i11.length;
          if (i11 && s11) {
            for (let e12 = t11; e12 < s11; ++e12) if (!sJ(i11[e12])) return i11[e12].highlight();
            for (let e12 = t11; e12 >= 0; --e12) if (!sJ(i11[e12])) return i11[e12].highlight();
          }
          return false;
        }
      ...
      let s5 = s3, { hideSeriesFromAT: s4 } = K, { describeSeries: s6 } = st, s9 = class extends Z {
        static compose(e10, t10, i10) {
          sd.compose(i10), sz.compose(i10), s5.compose(e10, t10, i10);
        }
        init() {
          this.newDataAnnouncer = new sd(this.chart), this.newDataAnnouncer.init(), this.keyboardNavigation = new s5(this.chart, this.keyCodes), this.keyboardNavigation.init(), this.hideTooltipFromATWhenShown(), this.hideSeriesLabelsFromATWhenShown();
        }
        ...
        onChartRender() {
          this.chart.series.forEach(function(e10) {
            false !== (e10.options.accessibility && e10.options.accessibility.enabled) && e10.visible && 0 !== e10.getPointsCollection().length ? s6(e10) : s4(e10);
          });
        }
        getKeyboardNavigation() {
      ...
      }, { unhideChartElementFromAT: s8 } = K, { getFakeMouseEvent: s7 } = S, { attr: ne, pick: nt } = w(), ni = class extends Z {
        constructor() {
        ...
        onChartUpdate() {
          ...
          e10.mapNavigation && e10.mapNavigation.navButtons.forEach((i10, s10) => {
            s8(e10, i10.element), t10.setMapNavButtonAttrs(i10.element, "accessibility.zoom.mapZoom" + (s10 ? "Out" : "In"));
          });
        }
        setMapNavButtonAttrs(e10, t10) {
          let i10 = this.chart;
          ne(e10, { tabindex: -1, role: "button", "aria-label": i10.langFormat(t10, { chart: i10 }) });
        }
        onChartRender() {
        ...
        onMapKbdArrow(e10, t10) {
          ...
          return [s7("mousedown", h2), s7("mousemove", c2), s7("mouseup", c2)].forEach((e11) => n2.dispatchEvent(e11)), e10.response.success;
        }
        onMapKbdTab(e10, t10) {
        ...
        simpleButtonNavigation(e10, t10, i10) {
          ...
          return new Q(r2, { keyCodeMap: [[[s10.tab, s10.up, s10.down, s10.left, s10.right], function(e11, t11) {
            ...
            return nt(i10(this, r2), this.response.success);
          }]], validate: function() {
      ...
      }, { doc: ns, isMS: nn, win: nr } = w(), no = { isHighContrastModeActive: function() {
        if (nn && nr.getComputedStyle) {
          let e10 = ns.createElement("div");
          e10.style.backgroundImage = "url(data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==)", ns.body.appendChild(e10);
          let t10 = (e10.currentStyle || nr.getComputedStyle(e10)).backgroundImage;
          return ns.body.removeChild(e10), "none" === t10;
        }
      ...
      function nd(e10, t10, i10, s10) {
        ...
        Object.keys(s10).forEach(function(n3) {
          let a2 = r2[n3];
          void 0 !== a2 && (nc(o2, s10[n3], a2), nl(32, false, e10, { [t10.join(".") + "." + n3]: i10.join(".") + "." + s10[n3].join(".") }));
        });
      }
      let nu = function(e10) {
        let t10 = e10.options.chart, i10 = e10.options.accessibility || {};
        ["description", "typeDescription"].forEach(function(s10) {
          t10[s10] && (i10[s10] = t10[s10], nl(32, false, e10, { [`chart.${s10}`]: `use accessibility.${s10}` }));
        }), e10.axes.forEach(function(t11) {
          let i11 = t11.options;
          i11 && i11.description && (i11.accessibility = i11.accessibility || {}, i11.accessibility.description = i11.description, nl(32, false, e10, { "axis.description": "use axis.accessibility.description" }));
          ...
          e11.series.forEach(function(i11) {
            Object.keys(t11).forEach(function(s10) {
              ...
              "accessibility.pointDescriptionFormatter" === s10 && (n2 = i11.options.accessibility && i11.options.accessibility.pointDescriptionFormatter), void 0 !== n2 && (nc(i11.options, t11[s10], "skipKeyboardNavigation" === s10 ? !n2 : n2), nl(32, false, e11, { [`series.${s10}`]: "series." + t11[s10].join(".") }));
            });
          });
        }(e10), nd(e10, ["accessibility"], ["accessibility"], { pointDateFormat: ["point", "dateFormat"], pointDateFormatter: ["point", "dateFormatter"], pointDescriptionFormatter: ["point", "descriptionFormatter"], pointDescriptionThreshold: ["series", "pointDescriptionEnabledThreshold"], pointNavigationThreshold: ["keyboardNavigation", "seriesNavigation", "pointNavigationEnabledThreshold"], pointValueDecimals: ["point", "valueDecimals"], pointValuePrefix: ["point", "valuePrefix"], pointValueSuffix: ["point", "valueSuffix"], screenReaderSectionFormatter: ["screenReaderSection", "beforeChartFormatter"], describeSingleSeries: ["series", "describeSingleSeries"], seriesDescriptionFormatter: ["series", "descriptionFormatter"], onTableAnchorClick: ["screenReaderSection", "onViewDataTableClick"], axisRangeDateFormat: ["screenReaderSection", "axisRangeDateFormat"] }), nd(e10, ["accessibility", "keyboardNavigation"], ["accessibility", "keyboardNavigation", "seriesNavigation"], { skipNullPoints: ["skipNullPoints"], mode: ["mode"] }), nd(e10, ["lang", "accessibility"], ["lang", "accessibility"], { legendItem: ["legend", "legendItem"], legendLabel: ["legend", "legendLabel"], mapZoomIn: ["zoom", "mapZoomIn"], mapZoomOut: ["zoom", "mapZoomOut"], resetZoomButton: ["zoom", "resetZoomButton"], screenReaderRegionLabel: ["screenReaderSection", "beforeRegionLabel"], rangeSelectorButton: ["rangeSelector", "buttonText"], rangeSelectorMaxInput: ["rangeSelector", "maxInputLabel"], rangeSelectorMinInput: ["rangeSelector", "minInputLabel"], svgContainerEnd: ["screenReaderSection", "endOfChartMarker"], viewAsDataTable: ["table", "viewAsDataTableButtonText"], tableSummary: ["table", "tableSummary"] });
      }, { defaultOptions: np } = w(), { doc: ng } = w(), { addEvent: nm, extend: nb, fireEvent: nf, merge: nx } = w(), { removeElement: ny } = S;
      class nv {
        constructor(e10) {
          this.init(e10);
        }
        init(e10) {
          if (this.chart = e10, !ng?.addEventListener) {
            this.zombie = true, this.components = {}, e10.renderTo.setAttribute("aria-hidden", true);
            return;
          }
          nu(e10), this.proxyProvider = new sS(this.chart), this.initComponents(), this.keyboardNavigation = new eJ(e10, this.components);
        }
        initComponents() {
          let e10 = this.chart, t10 = this.proxyProvider, i10 = e10.options.accessibility;
          this.components = { container: new es(), infoRegions: new eL(), legend: new to(), chartMenu: new eW(), rangeSelector: new sF(), series: new s9(), zoom: new ni(), navigator: new iV() }, i10.customComponents && nb(this.components, i10.customComponents);
        ...
        update() {
          ...
          nf(t10, "beforeA11yUpdate"), t10.types = this.getChartTypes();
          let s10 = i10.keyboardNavigation.order;
          this.proxyProvider.updateGroupOrder(s10), this.getComponentOrder().forEach(function(i11) {
            e10[i11].onChartUpdate(), nf(t10, "afterA11yComponentUpdate", { name: i11, component: e10[i11] });
          }), this.keyboardNavigation.update(s10), !t10.highContrastModeActive && false !== i10.highContrastMode && (no.isHighContrastModeActive() || true === i10.highContrastMode) && no.setHighContrastTheme(t10), nf(t10, "afterA11yUpdate", { accessibility: this });
        }
        destroy() {
          let e10 = this.chart || {}, t10 = this.components;
          Object.keys(t10).forEach(function(e11) {
            t10[e11].destroy(), t10[e11].destroyBase();
          }), this.proxyProvider && this.proxyProvider.destroy(), e10.announcerContainer && ny(e10.announcerContainer), this.keyboardNavigation && this.keyboardNavigation.destroy(), e10.renderTo && e10.renderTo.setAttribute("aria-hidden", true), e10.focusElement && e10.focusElement.removeFocusBorder();
        }
        getChartTypes() {
          let e10 = {};
      ...
      !function(e10) {
        ...
        function s10(e11) {
          let t11 = e11.options.accessibility;
          t11 && (t11.customComponents && (this.options.accessibility.customComponents = t11.customComponents, delete t11.customComponents), nx(true, this.options.accessibility, t11), this.accessibility && this.accessibility.destroy && (this.accessibility.destroy(), delete this.accessibility)), this.a11yDirty = true;
        }
        function n2() {
        ...
        e10.i18nFormat = F.i18nFormat, e10.compose = function(e11, o2, a2, l2, h2, c2) {
          eJ.compose(e11), sd.compose(l2), to.compose(e11, o2), eW.compose(e11), s9.compose(e11, a2, l2), F.compose(e11), eo.compose(e11, h2), c2 && sF.compose(e11, c2);
          let d2 = e11.prototype;
          d2.updateA11yEnabled || (d2.updateA11yEnabled = n2, nm(e11, "destroy", t10), nm(e11, "render", i10), nm(e11, "update", s10), ["addSeries", "init"].forEach((t11) => {
            nm(e11, t11, function() {
              this.a11yDirty = true;
            });
